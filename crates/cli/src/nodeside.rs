...
mod tests {
    ...
    fn node_side_texts() {
        assert_eq!(
            ...
            "cluster init is a node-side command and dstore-client-rs does not implement the dstore node; use the Go dstore binary (github.com/amber-store/dstore v0.1.9)"
        );
    }
